...
export default class CreatePost extends Component {
    ...
    handleFormSubmit = async (event) => {
        ...
        if (!this.state.imageFile || !this.state.title || !this.state.content || !this.state.description) {
            ...
            const uploadImage = await fetch(`http://hotgirl-back-end.herokuapp.com/uploads/image`, {
                method: 'POST',
                credentials: 'include',
                headers: {
            ...
            // Create Post
            const createPost = await fetch(`http://hotgirl-back-end.herokuapp.com/api/posts`, {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Accept': 'application/json',
